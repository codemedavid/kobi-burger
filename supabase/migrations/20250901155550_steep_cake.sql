/*
  # Add Kobi Burger Menu Items and Categories

  1. New Categories
    - Add dim-sum, noodles, rice-dishes, beverages categories for Kobi Burger
...
-- First, add the new categories for Kobi Burger
